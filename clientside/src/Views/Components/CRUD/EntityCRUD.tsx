...
interface IEntityCRUDProps<T extends Model> extends RouteComponentProps {
	...
	// % protected region % [Add extra IEntityCRUDProps fields here] off begin
...
class EntityCRUD<T extends Model> extends React.Component<IEntityCRUDProps<T>> {
	...
	protected renderEntityCollection = (routeProps: RouteComponentProps) => {
		// % protected region % [Override entity collection render here] off begin
		const {
			modelType, expandList, perPage, actionsMore, additionalBulkActions, additionalTableActions, removeViewAction,
		} = this.props;
		return (
			<EntityCollection
				{...routeProps}
