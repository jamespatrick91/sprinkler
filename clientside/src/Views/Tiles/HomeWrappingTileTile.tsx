...
// % protected region % [Add any customisations to default class definition here] end
	...
	public render() {
		let contents = (
			<>
				<EntityCRUD {...this.props} modelType={Models.UsersEntity} URLExtension={'CrudForm'}/>
				<EntityCRUD {...this.props} modelType={Models.UserprofilesEntity} URLExtension={'OtherCrudForm'}/>
			</>
		);
