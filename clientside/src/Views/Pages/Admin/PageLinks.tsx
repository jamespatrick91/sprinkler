...
const getPageLinks = (): AdminLink[] => [
	{
		// % protected region % [Override navigation link for UsersEntity here] off begin
		path: '/admin/usersentity',
		label: getModelDisplayName(Models.UsersEntity),
		entity: Models.UsersEntity,
		isMember: false
		// % protected region % [Override navigation link for UsersEntity here] end
	},
	{
		// % protected region % [Override navigation link for UserprofilesEntity here] off begin
		path: '/admin/userprofilesentity',
		label: getModelDisplayName(Models.UserprofilesEntity),
		entity: Models.UserprofilesEntity,
		isMember: false
		// % protected region % [Override navigation link for UserprofilesEntity here] end
	},
