...
namespace Sprinkler.Models {
	...
	public class SprinklerDBContext : AuditIdentityDbContext<User, Group, Guid>, IDataProtectionKeyContext
	// % protected region % [Change the class signature here] end
	{
		private readonly ILogger<SprinklerDBContext> _logger;
		...
		public DbSet<UserprofilesEntity> UserprofilesEntity { get; set; }
		public DbSet<DataProtectionKey> DataProtectionKeys { get; set; }

		static SprinklerDBContext()
		{
		...
		public SprinklerDBContext(
			...
			DbContextOptions<SprinklerDBContext> options,
			IHttpContextAccessor httpContextAccessor,
			ILogger<SprinklerDBContext> logger) : base(options)
		{
			_logger = logger;
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.ApplyConfiguration(new UserprofilesEntityConfiguration());
