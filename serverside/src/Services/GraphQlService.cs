...
{
	public class SprinklerGraphQlContext
	{
		public SprinklerDBContext DbContext { get; set; }
	...
	public class GraphQlService : IGraphQlService
	{
		...
		private readonly SprinklerDBContext _dataContext;
		...
		public GraphQlService(
			...
			SprinklerDBContext dataContext,
			...
			CancellationToken cancellation)
		{
			...
			var executionOptions = new ExecutionOptions
			{
				...
				Inputs = variables,
				UserContext = new SprinklerGraphQlContext
				{
