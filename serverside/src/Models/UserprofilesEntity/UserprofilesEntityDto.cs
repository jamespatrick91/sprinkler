...
namespace Sprinkler.Models
{
	...
	/// profiles
	/// </summary>
	public class UserprofilesEntityDto : ModelDto<UserprofilesEntity>
	{
		/// <summary>
		/// test
		/// </summary>
		...
		public override UserprofilesEntity ToModel()
		{
		...
		public override ModelDto<UserprofilesEntity> LoadModelData(UserprofilesEntity model)
		{
			Id = model.Id;
