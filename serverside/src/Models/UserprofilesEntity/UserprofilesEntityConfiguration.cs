...
namespace Sprinkler.Models {
	public class UserprofilesEntityConfiguration : IEntityTypeConfiguration<UserprofilesEntity>
	{
		public void Configure(EntityTypeBuilder<UserprofilesEntity> builder)
		{
