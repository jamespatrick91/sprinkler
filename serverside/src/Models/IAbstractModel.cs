...
namespace Sprinkler.Models {
	...
	public interface IAbstractModel
	{
		...
		void BeforeSave(EntityState operation, SprinklerDBContext dbContext, IServiceProvider serviceProvider);
		void AfterSave(EntityState operation, SprinklerDBContext dbContext, IServiceProvider serviceProvider, ICollection<ChangeState> changes);
