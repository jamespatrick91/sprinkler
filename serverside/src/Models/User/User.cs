...
namespace Sprinkler.Models {
	public class User : IdentityUser<Guid>, IOwnerAbstractModel
	{
		...
		public virtual void BeforeSave(EntityState operation, SprinklerDBContext dbContext, IServiceProvider serviceProvider)
		{
			// % protected region % [Add any before save logic here] off begin
			// % protected region % [Add any before save logic here] end
		}

		public virtual void AfterSave(EntityState operation, SprinklerDBContext dbContext, IServiceProvider serviceProvider, ICollection<ChangeState> changes)
		{
		...
		public virtual int CleanReference<T>(string reference, IEnumerable<T> models, SprinklerDBContext dbContext) where T : IOwnerAbstractModel
		{
