...
using Sprinkler.Graphql.Fields;
using Sprinkler.Graphql.Helpers;
using Sprinkler.Graphql.Types;
using Sprinkler.Models;
using Sprinkler.Models.RegistrationModels;
using GraphQL;
...
namespace Sprinkler.Graphql
{
	/// <summary>
	/// The GraphQL schema class for fetching and mutating data
	/// </summary>
	public class SprinklerSchema : Schema
	{
		public SprinklerSchema(IDependencyResolver resolver) : base(resolver)
		{
			Query = resolver.Resolve<SprinklerQuery>();
			Mutation = resolver.Resolve<SprinklerMutation>();
	...
	/// </summary>
	public class SprinklerQuery : QueryGraphType<SprinklerDBContext>
	{
		...
		public SprinklerQuery(IEfGraphQLService<SprinklerDBContext> efGraphQlService) : base(efGraphQlService)
		{
			// Add query types for each entity
			AddModelQueryField<UsersEntityType, UsersEntity>("UsersEntity");
			AddModelQueryField<UserprofilesEntityType, UserprofilesEntity>("UserprofilesEntity");
	...
	/// </summary>
	public class SprinklerMutation : ObjectGraphType<object>
	{
		private const string ConditionalWhereDesc = "A list of lists of where conditions. The conditions inside the " +
											"innermost lists are joined with and OR and the results of those " +
											"lists are joined with an AND";

		public SprinklerMutation()
		{
			Name = "Mutation";

			// Add input types for each entity
			AddMutationField<UsersEntityInputType, UsersEntityInputType, UsersEntityType, UsersEntity>("UsersEntity");
			AddMutationField<UserprofilesEntityInputType, UserprofilesEntityInputType, UserprofilesEntityType, UserprofilesEntity>("UserprofilesEntity");
