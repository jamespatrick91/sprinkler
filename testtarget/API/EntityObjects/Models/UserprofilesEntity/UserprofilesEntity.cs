...
namespace APITests.EntityObjects.Models
{
	public class UserprofilesEntity : BaseEntity
	{
		...
		public UserprofilesEntity()
		{
			EntityName = "UserprofilesEntity";

			InitialiseAttributes();
			InitialiseReferences();
		}

		public UserprofilesEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static UserprofilesEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static UserprofilesEntity GetInvalidEntity()
		{
			var userprofilesEntity = new UserprofilesEntity
			{
			};
			return userprofilesEntity;
		}
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static UserprofilesEntity GetValidEntity(string fixedStrValue = null)
		{
		...
		{
			return SaveToDB<Sprinkler.Models.UserprofilesEntity>(UserprofilesEntityDto.Convert(this));
		}
	}
}
