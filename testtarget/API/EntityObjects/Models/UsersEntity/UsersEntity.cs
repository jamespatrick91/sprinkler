...
namespace APITests.EntityObjects.Models
{
	public class UsersEntity : BaseEntity
	{
		...
		public UsersEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static UsersEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static UsersEntity GetInvalidEntity()
		{
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static UsersEntity GetValidEntity(string fixedStrValue = null)
		{
		...
		{
			return SaveToDB<Sprinkler.Models.UsersEntity>(UsersEntityDto.Convert(this));
		}
	}
}
