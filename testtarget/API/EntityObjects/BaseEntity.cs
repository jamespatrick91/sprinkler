...
using SprinklerDBContext = Sprinkler.Models.SprinklerDBContext;
using RestSharp;
...
namespace APITests.EntityObjects.Models
{
	...
	public abstract class BaseEntity
	{
		...
		internal Guid SaveToDB<T>(T model) where T : class, Sprinkler.Models.IOwnerAbstractModel
		{
			var configure = new StartupTestFixture();
			// % protected region % [Adjust the db context if required] off begin
			var context = new SprinklerDBContext(configure.DbContextOptions, null, null);
