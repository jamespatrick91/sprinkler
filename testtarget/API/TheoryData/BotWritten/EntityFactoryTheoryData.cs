...
namespace APITests.TheoryData.BotWritten
{
	...
	public class EntityFactorySingleTheoryData : TheoryData<EntityFactory, int>
	{
		...
		{
			Add(new EntityFactory("UsersEntity"), 1);
			Add(new EntityFactory("UserprofilesEntity"), 1);
		}
	}
	...
	public class EntityFactoryTheoryData : TheoryData<EntityFactory>
	{
		...
		{
			Add(new EntityFactory("UsersEntity"));
			Add(new EntityFactory("UserprofilesEntity"));
		}
	}
	...
	public class EntityFactoryMultipleTheoryData : TheoryData<EntityFactory, int>
	{
		...
		{
			var numEntities = 3;
			Add(new EntityFactory("UsersEntity"), numEntities);
			Add(new EntityFactory("UserprofilesEntity"), numEntities);
		}
	}
}