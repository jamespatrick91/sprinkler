...
Feature: UserprofilesEntity Bulk Option Selection
# WARNING: These Tests have been flagged as needing web fixes and are currently ignored

@UserprofilesEntity
Scenario: Select all UserprofilesEntitys on current page
...
@UserprofilesEntity
Scenario: I attempt to select all UserprofilesEntitys on all pages
Given I login to the site as a user
And I navigate to the UserprofilesEntity backend page
When I select all entities on current page
