...
Feature: Admin Submenu UsersEntity
	
	@UsersEntity
	Scenario: Admin Submenu UsersEntity
	...
	And I click the users admin submenu
	Then I assert that I am on the Users Entity backend page