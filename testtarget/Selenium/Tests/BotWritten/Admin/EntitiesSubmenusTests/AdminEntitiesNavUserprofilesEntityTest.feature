...
Feature: Admin Submenu UserprofilesEntity
	
	@UserprofilesEntity
	Scenario: Admin Submenu UserprofilesEntity
	...
	And I click the userprofiles admin submenu
	Then I assert that I am on the UserProfiles Entity backend page