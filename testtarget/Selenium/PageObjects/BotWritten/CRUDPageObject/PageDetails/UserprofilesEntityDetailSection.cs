...
namespace SeleniumTests.PageObjects.CRUDPageObject.PageDetails
{
	...
	public class UserprofilesEntityDetailSection : BasePage, IEntityDetailSection
	{
		...
		//Attribute Headers
		private readonly UserprofilesEntity _userprofilesEntity;
		...
		public UserprofilesEntityDetailSection(ContextConfiguration contextConfiguration, UserprofilesEntity userprofilesEntity = null) : base(contextConfiguration)
		{
			_driver = contextConfiguration.WebDriver;
			_driverWait = contextConfiguration.WebDriverWait;
			_isFastText = contextConfiguration.SeleniumSettings.FastText;
			_contextConfiguration = contextConfiguration;
			_userprofilesEntity = userprofilesEntity;
		...
		public void Apply()
		{
			...
			SetName(_userprofilesEntity.Name);
