...
namespace SeleniumTests.Factories
{
	internal class EntityDetailFactory
	{
		...
		public IEntityDetailSection CreateDetailSection(string entityName, BaseEntity entity = null)
		{
			...
			{
				"UsersEntity" => new UsersEntityDetailSection(_contextConfiguration, (UsersEntity) entity),
				"UserprofilesEntity" => new UserprofilesEntityDetailSection(_contextConfiguration, (UserprofilesEntity) entity),
